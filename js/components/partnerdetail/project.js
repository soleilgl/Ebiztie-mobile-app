      ...
      <Container style={styles.container}>
        ...
        <Content padder>
          <Card style={styles.mb}>
            ...
            <CardItem>
              <Body>
                <Image style={{ alignSelf: 'center', height: 150, resizeMode: 'cover', width: deviceWidth / 1.18, marginVertical: 5 }} source={proimg} />
                <Text>
            ...
            <CardItem>
             <View style={styles.btns}>
               <Card>
                ...
                <Card>
                  <CardItem style={{ borderBottomWidth: 1, borderColor: '#d3d3d3'}}>
                        <Text style={styles.btns_text}>成立</Text>
                        <Right>
                          <Icon name="arrow-forward" />
                        </Right>
                  </CardItem>
