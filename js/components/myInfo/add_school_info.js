...
class AddSchoolInfo extends Component {
    ...
    render() {
        const myAdditionalInfo = this.props.myInfo.mySkills;
        return (
    ...
    <Content padder>
        ...
        <ListItem>
        <Text style={{marginLeft:140, color:'#218bcb'}}>添加教育经历</Text>
        </ListItem>
...
export default connect(mapStateToProps) (AddSchoolInfo);
