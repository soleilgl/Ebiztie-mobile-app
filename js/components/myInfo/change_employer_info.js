...
class ChangeEmployerInfo extends Component {
    ...
    <Content padder>
        ...
        <ListItem>
        <Text style={{marginLeft:140, color:'#218bcb'}}>更改工作经验</Text>
        </ListItem>

        <Text>公司名称:<Text note></Text></Text>
        <ListItem>
        <InputGroup>
        <Input inlineLabel type="text" ref="companyname" />
            </InputGroup>
            </ListItem>
            <Text>开始时间:<Text></Text></Text>
        <ListItem>
        <InputGroup>
        <Input inlineLabel type="text" ref="starttime" />
            </InputGroup>
            </ListItem>
            <Text>结束时间:<Text></Text></Text>
        <ListItem>
        <InputGroup>
...
export default connect(mapStateToProps) (ChangeEmployerInfo);
