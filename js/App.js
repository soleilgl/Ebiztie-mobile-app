/**
 * Created by adelgeng on 10/31/19.
 */
...
// state结构较复杂，根据返回值拆分reducer,使每个只负责改变一小部分state
// CodePush.sync: real time update
    componentDidMount() {
            ...
            return (
                <Container theme={theme} style={{ backgroundColor: theme.defaultBackgroundColor }}>
                    <Content style={styles.container}>
                        <Modal style={[styles.modal, styles.modal1]} backdrop={false} ref={(c) => { this._modal = c; }} swipeToClose={false}>
